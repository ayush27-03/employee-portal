    ...
    <div class="auth-card">
      ...
      <div class="auth-body">
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
          ...
          $selectedRole = (int) $_POST['role_id'] ?? ''; //String value from form
          ...
          if (empty($username) || empty($password) || empty($selectedRole) || $selectedRole === 'select role') {
            ...
            try {
              ...
              if ($employee && password_verify($password, $employee['password'])) {
                ...
                // die(var_dump($selectedRole) . '  ' . var_dump($_SESSION['role'])); //@ Debu gStep to check
        
                //@ Verification of selected role with database role but using session
                if ((int) $selectedRole !== (int) $_SESSION['role']) {
